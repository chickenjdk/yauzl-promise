...
const {createInflateRaw} = require('node:zlib'),
	...
	calculateCrc32 = require('crc-32').buf,
	assert = require('simple-invariant'),
	{isObject, isBoolean, isPositiveInteger, isPositiveIntegerOrZero} = require('./is-it-type.js');
...
class ValidateCrc32Stream extends TransformStream {
	...
	_transform(chunk, encoding, cb) {
		...
		this.crc32 = calculateCrc32(chunk, this.crc32) >>> 0;
		cb(null, chunk);
	}
